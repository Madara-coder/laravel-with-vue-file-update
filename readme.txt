...
Above is the assessment task to hire a senior fullstack developer. And only 30 min is given to complete the above given task. Complete this project please

Write complete code along with it's working. Make sure it is working properly